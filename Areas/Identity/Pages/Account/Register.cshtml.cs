...
namespace ShoesShop.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "Mật khẩu lặp lại không trùng khớp.")]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        $"Vui lòng nhấp vào <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>đây</a> để xác thực tài khoản.");
